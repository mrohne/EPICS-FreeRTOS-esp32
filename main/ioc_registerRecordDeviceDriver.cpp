...
int ioc_registerRecordDeviceDriver(DBBASE *pbase)
{
    ...
    const char *bldTop = "/Volumes/MacLocal/opt/Espressif/EPICS-FreeRTOS-esp32/main";
...
static const iocshFuncDef rrddFuncDef = {
    ...
    "Example: ioc_registerRecordDeviceDriver pdbbase\n",
};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(ioc_registerRecordDeviceDriver(*iocshPpdbbase));
}
